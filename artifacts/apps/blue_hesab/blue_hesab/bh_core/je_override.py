...
class BlueJournalEntry(ERPJournalEntry):  # type: ignore[misc]
    ...
    - Inject bh_* dims from the SAME row into GL dicts (no overwrite)
    """
    ...
    def get_gl_entries(self, *args, **kwargs) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            def row_amounts(r) -> tuple[float, float]:
                # be robust across fields
            ...
            for r in rows:
                ...
                # 2) dims from row -> GL dict (no overwrite)
